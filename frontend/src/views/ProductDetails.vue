  ...
  methods: {
    ...
    async fetchProductDetails(productId: string | string[]) {
      try {
        const response = await fetch(
          `https://capsule-wardrobe.onrender.com/api/product/${productId}`,
          {
            method: "GET",
            headers: {
      ...
      try {
        const response = await fetch(
          `https://capsule-wardrobe.onrender.com/api/details/${productId}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
    ...
    async updateExistingBag() {
      try {
        if (this.bagExists()) {
          const response = await fetch(
            `https://capsule-wardrobe.onrender.com/api/bag/${this.bag.user_id}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
